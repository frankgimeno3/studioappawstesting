...
import { getPlatform, getProduct, listPlatforms } from "../graphql/queries";
...
export default function ProductUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = productRecord
      ? { ...initialValues, ...productRecord, platformID }
      : initialValues;
  ...
  React.useEffect(resetStateValues, [productRecord, platformID]);
